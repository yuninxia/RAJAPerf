...
// Root cause (AMD MI300A): 96.3% stalls from global_load_dwordx2.
// ell matrix (25x64) accessed with stride-64 between warp threads
// causes 25 cache line misses per warp per d-iteration.
//
// OPT 1: __restrict__ on all pointers
// OPT 2: Cache ell matrix in shared memory with +1 padding
//         to avoid LDS bank conflicts (stride-64 maps all m-threads
